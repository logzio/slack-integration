...
describe('search',() => {
  ...
  const validateSearchResult = (searchResults => {
    const content = JSON.parse(globalTestConfiguration.bot.api.files.files.content);
  ...
  it('search - test valid commands', (done) => {
    globalTestConfiguration.bot.usersInput(TestFunctions.createOneAccount(userId,teamId,channelId,'mixed-1-api-token', 'us-east-1', alias1))
      ...
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","last 3 minutes")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","last 3 min")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","last 3 m")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","last 3 hours")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","last 3 h")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.search(userId,teamId,channelId,"error","from 2019-02-17T13:01:46.000Z to 2019-02-17T13:01:06.057+0000")))
      .then(() => validateSearchResult(searchResults1))
      .then(() => {
        done();
      })
  ...
  it('search - test valid commands with alias', (done) => {
    globalTestConfiguration.bot.usersInput(TestFunctions.createOneAccount(userId,teamId,channelId,'mixed-1-api-token', 'us-east-1', alias1))
      .then((message) => expect(message.text).toBe(`Okay, you\'re ready to use ${alias1} in Slack!`))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","last 3 minutes",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","last 3 min",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","last 3 m",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","last 3 hours",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","last 3 h",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId,teamId,channelId,"error","from 2019-02-17T13:01:46.000Z to 2019-02-17T13:01:06.057+0000",alias1)))
      .then(() => validateSearchResult(searchResults1))
      .then(() => {
        done();
      })
  ...
  it('search - test valid commands', (done) => {
    globalTestConfiguration.bot.usersInput(TestFunctions.createOneAccount(userId, teamId, channelId, 'mixed-1-api-token', 'us-east-1', alias1))
      ...
      .then(() => globalTestConfiguration.bot.usersInput(TestFunctions.searchWithAlias(userId, teamId, channelId, "error", "last 3 minutes",alias2)))
